...
$header.="To: =?UTF-8?Q?".str_replace("+","_",str_replace("%","=",urlencode('Анатолий')))."?= <sasha130720@gmail.com>\r\n";
$header.="Subject: =?UTF-8?Q?".str_replace("+","_",str_replace("%","=",urlencode('Заказ portmone')))."?=\r\n";
