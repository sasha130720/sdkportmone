...
$header.="To: =?UTF-8?Q?".str_replace("+","_",str_replace("%","=",urlencode('Александр')))."?= <sasha130720@gmail.com>\r\n";
$header.="Subject: =?UTF-8?Q?".str_replace("+","_",str_replace("%","=",urlencode('Обратный звонок portmone')))."?=\r\n";
...
fputs($smtp_conn,"RCPT TO:<sasha130720  @gmail.com>\r\n");
$code = substr(get_data($smtp_conn),0,3);
